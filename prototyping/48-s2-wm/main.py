...
parser.add_argument("--grad_acc", type=int, default=1, help="Batches to accumulate per backprop step")
parser.add_argument("--lr_s1", type=float, default=5e-5, help="Learning rate for S1")
parser.add_argument("--lr_s2", type=float, default=5e-5, help="Learning rate for S2")
...
parser.add_argument("--n_bptt", type=int, default=1, help="Number of S2 inner loops")
parser.add_argument("--d_model", type=int, default=768, help="Model dimension")
parser.add_argument("--d_loop_feed_forward", type=int, default=2048, help="Feed forward dimension for looping transformer")
parser.add_argument("--n_enc_layers", type=int, default=8, help="Number of encoder layers")
...
parser.add_argument("--step_bias", type=float, default=0.15, help="Impose bias to encourage later steps to do better")
