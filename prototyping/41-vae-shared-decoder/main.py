...
dl_train = data.DataLoader(ds_train, collate_fn=collate_fn, batch_sampler=sampler_train, num_workers=8, pin_memory=True)
dl_val = data.DataLoader(ds_val, collate_fn=collate_fn, batch_sampler=sampler_val, num_workers=8, pin_memory=True)
