...
parser.add_argument("--lr_s1", type=float, default=1e-4, help="Learning rate for S1")
...
parser.add_argument("--n_bptt", type=int, default=2, help="Number of S2 inner loops")
