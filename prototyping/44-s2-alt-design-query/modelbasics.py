...
# Upgraded MultiheadAttention and TransformerEncoderLayer, TransformerDecoderLayer
# with rotary position embeddings.

# WARNING: We edited the library code in functional.py right at the bottom
# to add the rotary position embedding, and haven't yet pulled this out here.
