...
class BPTTTransformer(L.LightningModule):
    ...
    def __init__(self, d_model, nhead, num_encoder_layers, dropout, ntoken, lr, pad_token_id, weight_decay, backprop_every):
        super().__init__()
    ...
    def forward(self, x: torch.Tensor, padding_mask: torch.Tensor=None) -> torch.Tensor:
        ...
        for i in range(self.backprop_every):
            x = self.transformer_encoder(x, src_key_padding_mask=padding_mask) # (seq_len, bs, d_model)
