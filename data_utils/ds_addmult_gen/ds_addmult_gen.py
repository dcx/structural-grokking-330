# generator script for addmult-mod10
# addmult-mod10: add and multiply, with modulo 10
...
def evaluate_single_expression(input_example: str) -> str:

    parser = Lark(calc_grammar, start='expr')
    interpreter = CalcInterpreter()

    output = interpreter.transform(parser.parse(input_example))
